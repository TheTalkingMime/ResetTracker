...
Stat("meta", "igt", "minecraft:custom", "minecraft:play_one_minute", handler=lambda ticks: ticks / 20)
...
Stat("luck", "iron golem killed", "minecraft:iron_golem", "minecraft:blaze")
Stat("luck", "iron collected", "minecraft:picked_up", "minecraft:blaze")
